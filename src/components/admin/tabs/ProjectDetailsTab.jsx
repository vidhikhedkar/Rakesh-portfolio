...
const ProjectDetailsTab = () => {
    ...
    const deleteParagraph = (section, index) => {
        setDetails((prev) => ({
            ...prev,
            [section]: {
                ...(prev[section] || {}),
    ...
    const updateEcosystemItem = (index, field, value) => {
        setDetails((prev) => {
            const updated = [
                ...(prev.ecosystem || []),
            ];
    ...
    const deleteEcosystemItem = (index) => {
        setDetails((prev) => ({
            ...prev,
            ecosystem: (
                prev.ecosystem || []
    ...
    const updateChallengeCard = (index, field, value) => {
        setDetails((prev) => {
            const cards = [
                ...(prev.challengeSection
                    ?.cards || []),
    ...
    const deleteChallengeCard = (index) => {
        setDetails((prev) => ({
            ...prev,
            challengeSection: {
                ...(prev.challengeSection ||
    ...
    const updateOutcomeCard = (index, field, value) => {
        setDetails((prev) => {
            const cards = [
                ...(prev.outcome?.cards ||
                    []),
